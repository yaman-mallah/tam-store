        ...
        <>
            <ul className='d-flex align-items-center gap-3'>
                <li className='d-flex flex-column align-items-center'>
                    <NavLink to='/sign-in' className="d-flex flex-column align-items-center gap-2">
                        ...
                        <p className="subText2">sign in</p>
                    </NavLink>
                </li>
                <li className='d-flex flex-column align-items-center'>
                ...
                <li className='d-flex flex-column align-items-center'>
                    <NavLink to='/cart' className="d-flex flex-column align-items-center gap-2">
                        ...
                        <p className="subText2">My cart</p>
                    </NavLink>
                </li>
            </ul>
